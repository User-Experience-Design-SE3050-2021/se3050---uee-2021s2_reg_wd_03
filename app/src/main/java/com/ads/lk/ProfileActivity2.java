...
import com.ads.lk.databinding.ActivityBprofileBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsignin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ProfileActivity2.this, Edit2Activity.class));
        ...
        btnsignin4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ProfileActivity2.this, Changepw2Activity.class));
